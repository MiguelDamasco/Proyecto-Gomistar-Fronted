...
const ModalRemoveDocumentShip5 = ({closeModal, idShip, token}) => {
    ...
    const deleteDocument = async () => {
        ...
        try {
            ...
            const response = await axios.delete(
                "http://localhost:8115/radio_communications/delete_document",
                {
                    headers: { Authorization: `Bearer ${token}` },
                    params: { pIdShip: idShip, pType: "5" },
                }
            );
        ...
        <div className="background-container">
            <div className="main-container">
                ...
                <div className="body-container">
                    {!loading && <p>Estas seguro que quieres eliminar el documento <strong>Licencia de estación radioeléctrica</strong>?</p> }
...
export default ModalRemoveDocumentShip5;