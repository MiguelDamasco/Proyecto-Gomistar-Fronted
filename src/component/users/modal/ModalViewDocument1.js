...
const ModalViewDocument1 = ({ closeModal, idUser, token }) => {
    ...
    useEffect(() => {
        const fetchDocument = async () => {
            setLoading(true);
            try {
                const response = await axios.get('http://localhost:8115/health_card/get_document', {
...
export default ModalViewDocument1;