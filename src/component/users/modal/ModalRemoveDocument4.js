...
const ModalRemoveDocument4 = ({closeModal, idUser, token}) => {
    ...
    const deleteDocument = async () => {
        ...
        try {
            ...
            const response = await axios.delete(
                "http://localhost:8115/identity_card/delete",
                {
        ...
        <div className="background-container">
            <div className="main-container">
                ...
                <div className="body-container">
                    {!loading && <p>Estas seguro que quieres eliminar el documento <strong>cedula de identidad</strong>?</p> }
...
export default ModalRemoveDocument4;